...
# 튜닝 가이드:
#   - 빔이 크게 진동 → KP와 KI를 낮춘다
#   - 정상상태 오차 남음 → KI를 약간 높인다
#   - 빠른 진동(떨림) → KD를 낮추고 D_LPF_HZ를 낮춘다
# 진동 심함 → 더욱 보수적인 게인 설정
KP = 0.03                  # 비례 게인 (대폭 낮춤: 0.08 → 0.03)
KI = 0.05                  # 적분 게인 per second (대폭 낮춤: 0.15 → 0.05)
KD = 0.0                   # 미분 게인 비활성화 (진동 유발 가능성)
D_LPF_HZ = 10.0            # 미분항 저역통과 (낮춤: 20 → 10)
I_LIMIT = 0.3              # 적분항 클램프 unit (낮춤: 0.4 → 0.3)
